(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('util'), require('rxjs'), require('dexie'), require('rxjs/operators'), require('rxjs/internal/util/noop')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/common/http', 'util', 'rxjs', 'dexie', 'rxjs/operators', 'rxjs/internal/util/noop'], factory) :
	(factory((global['ngx-jsonapi'] = {}),global.ng.core,global.common,global.http,global.util,global.rxjs,global.Dexie,global.operators,global.noop));
}(this, (function (exports,core,common,http,util,rxjs,Dexie,operators,noop) { 'use strict';
